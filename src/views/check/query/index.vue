<template>
  <div class="reslutWrap">
    ...
    <div class="queryCond">
      ...
      <div class="queryItem">
        预警等级：
        <el-select v-model="levelValue" placeholder="请选择户类型">
          <el-option
        ...
        是否核实：
        <el-select v-model="isCheckValue" placeholder="请选择是否核实">
          <el-option
    ...
    <div class="queryResult">
      ...
      <el-table :data="queryData">
        ...
        <el-table-column prop="cun" label="所在村" width="100" />
        <el-table-column prop="level" label="预警等级" width="120" />
        <el-table-column prop="isCheck" label="是否核实" width="100" />
        <el-table-column prop="checkRes" label="核实结果" width="100" />
        <el-table-column prop="checkTime" label="核实周期" width="100" />
      </el-table>
    </div>
    <!-- 导出文件 -->
